        ...
        <main class="flex-1 p-4 md:p-8 overflow-y-auto">
            ...
            <section class="mb-8 animate-fade-in" style="animation-delay: 0.2s;">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="glass-card p-8 rounded-[2.5rem] group hover:border-cyan-400/50 transition-all duration-500">
                        <div class="absolute top-0 right-0 p-6">
                            <span class="px-3 py-1 bg-white/5 text-white/30 rounded-full text-[8px] font-black uppercase tracking-widest border border-white/10">Clôturé</span>
                        </div>
                        <h4 class="text-xl font-black text-white uppercase mb-2 italic">Portfolio Cyberpunk v1</h4>
                        <p class="text-white/40 text-xs mb-6 leading-relaxed line-clamp-2 uppercase tracking-tighter">Réalisation d'une interface immersive en utilisant Tailwind CSS et GSAP...</p>
                        
                        <div class="flex items-center justify-between pt-6 border-t border-white/5 text-white/20">
                            <span class="text-[9px] uppercase font-black tracking-widest">Validé par 22/24</span>
            ...
            <footer class="mt-12 mb-8 text-center">
                <p class="text-[10px] text-white/20 uppercase tracking-[0.5em]">YouCode Teacher Interface <span class="text-cyan-500/40 italic underline decoration-cyan-500/20">v2.4.0</span></p>
            </footer>
        </main>
    </div>

    <div id="BriefModal" class="hidden fixed inset-0 bg-black/90 backdrop-blur-md z-50 flex items-center justify-center p-4">
        <div class="glass-card w-full max-w-2xl p-10 rounded-[2.5rem] border-cyan-400/30 animate-fade-in shadow-[0_0_50px_rgba(34,211,238,0.1)]">
            ...
            <form class="space-y-6 text-left">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div class="space-y-2">
                        <label class="text-cyan-400/60 text-[9px] font-black uppercase tracking-widest ml-2 italic">Deadline</label>
                        <input type="date" class="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-5 text-white outline-none focus:border-cyan-400/50 transition-all">
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="flex flex-wrap gap-2 p-4 bg-white/[0.02] border border-white/10 rounded-2xl">
                        <label class="flex items-center gap-2 px-3 py-2 bg-white/5 rounded-lg border border-white/10 cursor-pointer hover:border-cyan-400 transition-all">
                            <input type="checkbox" class="accent-cyan-400">
                            <span class="text-[10px] uppercase font-black text-white/60">SQL Master</span>
                        </label>
                        <label class="flex items-center gap-2 px-3 py-2 bg-white/5 rounded-lg border border-white/10 cursor-pointer hover:border-cyan-400 transition-all">
                            <input type="checkbox" class="accent-cyan-400">
                            <span class="text-[10px] uppercase font-black text-white/60">UML Design</span>
                        </label>
                        <label class="flex items-center gap-2 px-3 py-2 bg-white/5 rounded-lg border border-white/10 cursor-pointer hover:border-cyan-400 transition-all">
                            <input type="checkbox" class="accent-cyan-400">
                            <span class="text-[10px] uppercase font-black text-white/60">Auth System</span>
                        </label>
                    </div>
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <textarea rows="4" class="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-5 text-white outline-none focus:border-cyan-400/50 transition-all"></textarea>
                </div>
