...
<body class="bg-[url('https://42.fr/wp-content/uploads/2021/07/Background-RM-2000x1132.jpg')] bg-cover bg-center bg-no-repeat min-h-screen font-sans text-white overflow-hidden">
    ...
    <div id="SprintModal" class="hidden fixed inset-0 bg-black/90 backdrop-blur-md z-50 flex items-center justify-center p-4">
        <div class="glass-card w-full max-w-lg p-10 rounded-[2.5rem] border-cyan-400/30">
            ...
            <form class="space-y-6 text-left">
                ...
                <div class="space-y-2">
                    <label class="text-cyan-400/60 text-[9px] font-black uppercase tracking-widest ml-2">Assigner à (Formateur)</label>
                    <select class="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-5 text-white outline-none focus:border-cyan-400/50 transition-all appearance-none">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div class="space-y-2">
                        ...
                        <input type="date" class="w-full bg-white/5 border border-white/10 rounded-2xl py-4 px-5 text-white outline-none focus:border-cyan-400/50">
                    </div>
                    <div class="space-y-2">
